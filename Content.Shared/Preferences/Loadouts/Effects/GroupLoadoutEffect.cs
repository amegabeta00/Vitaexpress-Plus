...
public sealed partial class GroupLoadoutEffect : LoadoutEffect
{
    ...
    public override bool Validate(HumanoidCharacterProfile profile, RoleLoadout loadout, LoadoutPrototype proto, ICommonSession? session, IDependencyCollection collection, [NotNullWhen(false)] out FormattedMessage? reason) // Europa
    {
        ...
        {
            if (effect.Validate(profile, loadout, proto, session, collection, out reason)) // Europa
                continue;
