...
namespace Content.Server.Preferences.Managers
{
    ...
    public sealed class ServerPreferencesManager : IServerPreferencesManager, IPostInjectInit
    {
        ...
        private ISharedSponsorsManager? _sponsors; // Europa
        ...
        // private int MaxCharacterSlots => _cfg.GetCVar(CCVars.GameMaxCharacterSlots); // Europa

        public void Init()
        {
            IoCManager.Instance!.TryResolveType(out _sponsors); // Europa
        ...
        private async void HandleSelectCharacterMessage(MsgSelectCharacter message)
        {
            ...
            if (index < 0 || index >= GetMaxUserCharacterSlots(userId)) // Europa
            {
                return;
            }
        ...
        public async Task SetProfile(NetUserId userId, int slot, ICharacterProfile profile)
        {
            ...
            if (slot < 0 || slot >= GetMaxUserCharacterSlots(userId)) // Europa
                return;
        ...
        public async Task LoadData(ICommonSession session, CancellationToken cancel)
        {
            ...
            else
            {
                ...
                async Task LoadPrefs()
                {
                    ...
                    // Europa-Start | Remove sponsor markings from expired sponsors
        ...
        public void FinishLoad(ICommonSession session)
        {
            ...
            {
                MaxCharacterSlots = GetMaxUserCharacterSlots(session.UserId) // Europa
            };
        ...
        // Europa-Start | Calculate total available users slots with sponsors
        ...
        private PlayerPreferences SanitizePreferences(ICommonSession session, PlayerPreferences prefs, IDependencyCollection collection)
        {
            ...
            var sponsorPrototypes = _sponsors != null && _sponsors.TryGetServerPrototypes(session.UserId, out var prototypes) ? prototypes.ToArray() : []; // Europa
