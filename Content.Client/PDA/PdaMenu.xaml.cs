...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        private string _coords = Loc.GetString("comp-pda-ui-unknown");
        ...
        public PdaMenu()
        {
            ...
            PdaCoordinatesButton.OnPressed += _ =>
            {
                _clipboard.SetText(_coords);
            };
        ...
        public void UpdateState(PdaUpdateState state)
        {
            ...
            if (state.Coordinates == null)
                _coords = Loc.GetString("comp-pda-ui-unknown");
            else
            {
                PdaCoordinates.SetMarkup(Loc.GetString("comp-pda-ui-pda-cords",
                    ("cords", state.Coordinates)));
            }
