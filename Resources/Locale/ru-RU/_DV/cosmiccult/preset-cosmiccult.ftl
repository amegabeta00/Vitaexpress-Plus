...
cult-alert-recall-shuttle = На борту станции обнаружена высокая концентрация Λ-CDM неизвестного происхождения. Все аномальные объекты должны быть удалены, прежде чем будет разрешена эвакуация.
