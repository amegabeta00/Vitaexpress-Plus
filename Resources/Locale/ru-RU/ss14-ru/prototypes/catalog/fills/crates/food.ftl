...
ent-CrateFoodGetMore = ящик Гетмор Бейкмор
    .desc = Закуски и ингредиенты бренда Гетмор для креативного повара — и всё это без необходимости опустошать автоматы Гетмор на вашей станции!
...
ent-CrateFoodHappyHonkBigBite = доставка еды Хэппи Хонк
