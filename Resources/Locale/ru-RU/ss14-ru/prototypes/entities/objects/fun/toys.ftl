...
ent-PlushieSpaceLizard = плюшевый космический ящер
    .desc = Очаровательная мягкая игрушка, напоминающая ящера в ВКД скафандре. Изготовлена Центком в рамках показательной инициативы по борьбе с дискриминацией по видовому признаку в рабочей среде. "Приветствуйте своих новых коллег как вы приветствуете эту игрушку, с распростёртыми объятиями!".
...
ent-PonderingOrb = шар размышлений
    .desc = Задумайся чувак... реально.
ent-ToySword = энергетический меч
    .desc = Новый пластиковый меч от Синди-Кот! Имеет реалистичный звук и насыщенный цвет! Почти как настоящий!
