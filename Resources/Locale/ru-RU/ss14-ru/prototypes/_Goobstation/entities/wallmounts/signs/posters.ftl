ent-PosterLegitGoobWorkHard = Работай усердно
    .desc = Если будешь работать достаточно усердно, ТЫ сможешь получить собственный НаноТрейзен Пламбинг Плюс! Только выживи достаточно долго, чтобы забрать его!..
