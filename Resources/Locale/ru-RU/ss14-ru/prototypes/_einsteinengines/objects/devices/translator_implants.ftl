...
ent-DraconicTranslatorImplant = имплант "переводчик Драконового"
...
ent-MofficTranslatorImplant = имплант "переводчик Моффик"
    .desc = Имплант, созданный для одомашнивания тараканомолей. Впоследствии позволяет общаться с мотыльками.
