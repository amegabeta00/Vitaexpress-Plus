...
traitor-waffleco-goal = Вы не здесь, чтобы устраивать показательное выступление. Может, другие агенты Ваффл Ко. и будут этим заниматься, но ваша задача — просто выполнить цели.
