...
screams-in-agony = { $entity } кричит от боли и нервно дергается!
...
passes-out-pain = У { $entity } перехватывает дыхание, и он падает в обморок!

woundable-dodged = { $entity } едва увернулся!
