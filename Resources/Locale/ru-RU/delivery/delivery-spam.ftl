...
delivery-spam-reasons-to-chose-nanotrasen =
    ...
    ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ НАНОТРЕЙЗЕН, МИРНЫЕ СОТРУДНИКИ СИНДИКАТА ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!
...
delivery-spam-reasons-to-choose-syndicate =
    ...
    { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ НАНОТЕЙЗЕН[/head]" }
...
delivery-spam-alternate-timeline =
    ...
    { "[head=2]Это официальное уведомление [color=red]Начальника Службы Безопасности[/color] Космической станции 15 НаноТрейзен.[/head]" }
...
delivery-spam-rage-cage = [color=#aaaaaa]▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀[/color]
    ...
    Скрытая в глубинах станции НаноТрейзен, запатентованная [color=#FF0000][bold]КЛЕТКА ЯРОСТИ[/bold][/color]! Эта электрифицированная арена создана только для сильнейших, в [color=#FF0000][bold]КЛЕТКЕ ЯРОСТИ[/bold][/color] трусы отделяются от воинов, салаги — от солдат, а неудачники — от победителей.
    ──────────────────────────────────────────
...
delivery-spam-voyage-advertisement = [head=2]Присоединяйтесь к нам на первом рейсе...[/head]
    ...
    ░▀░▀░▀░▀░░░▀░░░▀▀▀░▀░▀░▀░▀░▀░▀░▀▀▀░▀▀▀░▀░░
     ...
     { "[head=3]Исследуйте руины Агатара***, теперь открытые для публики благодаря помощи лучших учёных НаноТрейзен. Все тайны древней Агатарской цивилизации раскопаны и выставлены для вашего удовольствия![/head]" }
